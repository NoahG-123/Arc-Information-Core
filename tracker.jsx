...
const OVERVIEW = {
  summary: "Day 48. The April 7 eighth-hour deadline was extended a fourth time — the war continues with no ceasefire and no framework in sight. The mid-April supply cliff has arrived: SPR buffer exhausted, Iranian exemptions expired, market absorbing the full disruption without cushion. Oil prices are in the $150+ modeling range. Kharg Island damage has created an independent production suppression on top of Strait paralysis — the oil crisis is now partially decoupled from the military situation. IRGC has not executed the Stargate UAE threat in 14 days: either power plant targeting restraint is holding or the threat was deterrent posture. The DOJ 9th Circuit brief on Anthropic is due April 30 — 13 days away — and will reveal whether the administration intends to fight or settle. Russia has used 48 days of US distraction to advance in Donetsk. Sudan is getting worse with zero international coverage. Gaza famine deepening. The world is running several crises in parallel with no bandwidth to address the secondary ones.",
  leaderboard: [
    {code:"IRAN-01", title:"Operation Epic Fury", change:"Day 48. Fourth deadline extension. No ceasefire. Kharg Island damage now independently suppressing oil exports. IRGC Stargate threat not executed in 14 days.", heat:5, status:"active-war"},
    {code:"ECON-01", title:"Oil Shock & Global Economy", change:"Mid-April supply cliff arrived — SPR exhausted, exemptions expired. Market absorbing full disruption. $150+ range now active. Stagflation risk rising.", heat:5, status:"escalating"},
    {code:"AI-SEC-01", title:"AI Infrastructure Under Fire", change:"IRGC Stargate UAE threat not executed in 14 days — deterrent posture or condition not met. Gulf AI infrastructure risk remains elevated through Day 48.", heat:5, status:"escalating"},
    {code:"ANTHRO-01", title:"Anthropic vs. Pentagon", change:"DOJ 9th Circuit filing due April 30 — 13 days. Brief will reveal fight-or-settle posture. Amicus coalition breadth requires direct rebuttal.", heat:4, status:"escalating"},
    {code:"GEO-01", title:"US-China Strategic Competition", change:"48 days of uninterrupted observation of US warfighting capacity is an intelligence gift to Beijing. China restraint holding — Taiwan arms sale still shelved.", heat:4, status:"developing"},
    {code:"CHINA-01", title:"China — Rise & Reorientation", change:"China maintaining restraint through Day 48. Fuel costs rising domestically but Taiwan concession holding. Trump-Xi summit still pending.", heat:4, status:"developing"},
    ...
    {code:"CANADA-01", title:"Canada — Four Shocks Simultaneously", change:"Mid-April supply cliff adds oil windfall but accelerates inflation simultaneously. CUSMA negotiations ongoing under tariff pressure. Stagflation risk real.", heat:4, status:"developing"},
    ...
    {code:"AFRICA-01", title:"Africa — Great Power Arena", change:"Oil shock deepening at supply cliff — African importers with no forex buffer facing full unmitigated disruption. Multiple governments at fiscal stress threshold.", heat:3, status:"developing"},
  ],
  cross_story_alerts: [
    {
      codes:["IRAN-01","ECON-01","AI-SEC-01"],
      date:"Apr 17 2026",
      title:"War-Economy-Tech Convergence: Supply Cliff Arrived",
      alert:"Day 48 with supply cliff materializing: SPR exhausted, Kharg Island damage independent of Strait, $150+ oil range now active. The IRGC Stargate UAE threat not executing in 14 days reduces the AI infrastructure acute risk but the broader compounding system (war-economy-tech) is locked in. A ceasefire at this point stops the military track but the economic damage — insurance repricing, Kharg infrastructure, global recession risk — is already embedded and persists independently.",
      severity:"critical"
    },
    {
      codes:["ANTHRO-01","AI-GOV-01","GEO-01"],
      date:"Apr 17 2026",
      title:"AI Governance: April 30 is the Next Decision Point",
      alert:"The DOJ 9th Circuit brief due April 30 is the next structural hinge in the AI governance race-to-bottom story. If the brief is broad — arguing unlimited government authority over AI companies — it confirms the race-to-bottom incentive permanently. If narrow or if a settlement emerges, courts remain a viable governance mechanism. Three stories converging on the same 13-day window.",
      severity:"high"
    },
    {
      codes:["IRAN-W01","UKR-01","SDN-01","PAL-01"],
      date:"Apr 17 2026",
      title:"Secondary Theater Deterioration During Distraction",
      alert:"48 days of US focus on Iran has produced measurable deterioration across all secondary theaters: Russia has advanced in Donetsk, Sudan's RSF has advanced with zero international coverage, Gaza famine is deepening with diplomatic bandwidth consumed by the Strait crisis, and Hezbollah is burning its stockpile with no ceasefire in sight. These are not independent developments — they are the cost of running one major crisis while the rest of the world continues to move.",
      severity:"high"
    },
    {
      codes:["CARNEY-01","ECON-CA-01","CUSMA-01"],
      date:"Apr 17 2026",
      title:"Canada Stagflation Trap",
      alert:"The mid-April supply cliff has arrived at the exact moment CUSMA negotiations are intensifying. Canada is simultaneously receiving an oil revenue windfall and absorbing accelerating inflation from the same shock. The Bank of Canada faces a stagflation scenario — recession risk from tariffs meets inflation from oil — with limited room on either monetary policy axis. Carney's fiscal buffer from oil revenue is real but the window for it to matter in CUSMA negotiations is narrow.",
      severity:"high"
    },
  ]
};
...
const EVENTS = [
  {date:"Apr 17 2026", code:"ECON-01", type:"STATUS_UPDATE", content:"Mid-April supply cliff arrived. SPR buffer exhausted, Iranian exemptions expired. Market absorbing full disruption without cushion. $150+ barrel range now in active modeling. Stagflation risk elevated."},
  {date:"Apr 17 2026", code:"IRAN-W01", type:"STATUS_UPDATE", content:"Day 48. Fourth deadline extension confirmed. Kharg Island damage now independently suppressing Iranian oil exports. IRGC Stargate UAE threat not executed in 14 days since April 3 issuance."},
  {date:"Apr 17 2026", code:"ANTHRO-01", type:"STATUS_UPDATE", content:"DOJ 9th Circuit filing deadline April 30 now 13 days away. Brief will reveal fight-or-settle posture and define the appellate legal theory for military AI constraints."},
  {date:"Apr 17 2026", code:"UKR-01", type:"STATUS_UPDATE", content:"Russia has used 48 days of US distraction to advance incrementally in Donetsk. European NATO support accelerating. Istanbul talks structurally stalled."},
...
const STORIES = [
  {
    id:1,cat:"ai",code:"ANTHRO-01",heat:4,status:"escalating",updated:"Apr 17 2026",
    title:"Anthropic vs. Pentagon",
    sub:"AI Governance & Military Use Dispute",
    card:"DOJ 9th Circuit filing deadline is April 30 — 13 days away. AnthroPAC operationalizing. The amicus coalition is the most significant development of the past 10 days: it signals institutional breadth that the administration will have to address directly in its appellate brief.",
    ...
    summary:"The DOJ 9th Circuit filing deadline is April 30 — 13 days out. Judge Rita Lin granted the preliminary injunction March 26, calling it First Amendment retaliation. The amicus coalition — Microsoft, retired US generals, Catholic theologians — is the institutional breadth the DOJ must address directly in its brief. AnthroPAC launched April 3 and is operationalizing. Emil Michael called the ruling a disgrace. Deal revival chatter continues. The next two weeks are the most consequential window in this case: the DOJ brief will define the appellate argument and may signal whether the administration intends to fight or settle.",
    ...
    insights:["The preliminary injunction is the most important legal development — it means a federal judge looked at the Pentagon's conduct and called it First Amendment retaliation. That framing will define the appellate argument.","The amicus brief coalition — Microsoft, generals, theologians — is structurally significant. It signals that Anthropic's position has mainstream institutional support, not just tech-sector sympathy.","AnthroPAC is the escalation nobody expected. Anthropic is now directly entering electoral politics on the AI governance question. That changes the long-term power dynamics regardless of how the court case resolves.","Emil Michael calling the ruling a disgrace tells you where the Trump administration's posture sits — this is not softening.","The deal revival chatter and the escalation signals are happening simultaneously. Both sides may be positioning for a negotiated settlement while continuing the legal battle as leverage.","The race-to-the-bottom dynamic: OpenAI signed standard all-lawful-purposes language, collected the benefit of Anthropic's stand, and Altman defended government authority. The industry now has a visible split between constraint-accepting and constraint-refusing labs.","With 13 days to the DOJ filing, the appellate brief will reveal the administration's actual legal theory. If it is narrow — defending the specific designation on procedural grounds — that suggests settlement is still possible. If it is broad — arguing the government has unlimited authority over AI companies it designates as security risks — it signals a fight to the end and a precedent attempt that goes far beyond the Anthropic case.","The Iran war context matters here: Claude was operationally embedded in Pentagon classified networks during the strikes while the ban was theoretically in effect. If this fact surfaces in the DOJ brief or court proceedings, it transforms the case from a governance dispute into an operational crisis with national security dimensions."],
  ...
  {
    id:3,cat:"geopolitics",code:"IRAN-01",heat:5,status:"active-war",updated:"Apr 17 2026",
    title:"Operation Epic Fury",
    sub:"US-Israel Strikes on Iran — Day 48",
    card:"Day 48. The April 7 8pm deadline was extended a fourth time. War continues. Kharg Island damage is now suppressing Iranian oil exports independently of the Strait. Diplomatic track still active — Oman serving as channel. IRGC Stargate UAE threat not executed. Human cost mounting.",
    ...
    summary:"Day 48. The April 7 eighth-hour deadline was extended a fourth time — no ceasefire, war continues. Kharg Island, struck April 7, is now suppressing Iran's oil exports independently of the Strait: even a ceasefire that reopens the waterway will not immediately restore Iranian production. Iran's 10-point counter-proposal remains the stated negotiating position. IRGC has not executed its threatened annihilation of Stargate UAE — the threat was conditional on US striking Iranian power plants, which appear not to have been struck. Oman is serving as the primary diplomatic back-channel. Hezbollah, Iraqi militias, and Houthis remain in active operations. Human cost continues to mount with each day of no settlement.",
  ...
  {
    id:4,cat:"geopolitics",code:"GEO-01",heat:4,status:"developing",updated:"Apr 17 2026",
    title:"US-China Strategic Competition",
    sub:"Dollar, Taiwan, Trade and AI Dominance",
    card:"Trump-Xi summit still pending — now in mid-April window. China has maintained strategic restraint through Day 48 of Iran war. 48 days of US THAAD depletion and military focus on Middle East are an extended intelligence gift to Beijing on US warfighting capacity and political limits.",
    ...
    insights:["The Al Jazeera report that Trump delayed Taiwan arms sale after Xi's call — and that China's restraint on Iran is the price of that delay — is the most important structural detail in this story. If true, it means China traded Iran for Taiwan already.","China's military equipment failures in Iran (drones, air defense, Venezuelan radar) are a gift to Taiwan analysts and a humiliation for Beijing. The PLA is watching its own hardware get exposed in real time.","Xi learning from the Iran war that the US is still militarily powerful but politically limited — can only fight one war at a time, allies not informed of strikes in advance. This is simultaneously reassuring and opportunistic for Beijing.","The THAAD depletion math is public. Everyone in Beijing knows it. The question is whether they see it as a window or a warning.","Canada's China trade strategy (canola deal, EV tariffs) is running directly into Trump's 100% tariff threat. Carney is trying to hedge both relationships simultaneously and may be forced to choose.","48 days of uninterrupted observation of the US military conducting a major Middle East operation has produced an extraordinary intelligence picture for Beijing: THAAD burn rates, operational tempo, political decision cycles, allied consultation patterns, and the domestic US constraints on escalation. This is the kind of strategic assessment that normally takes years to assemble. China has it compressed into 48 days.","China's sustained restraint through Day 48 — despite domestic fuel costs rising and rhetorical pressure from nationalist voices — reflects Xi's core calculation: the Taiwan concession traded for Iran restraint is worth more than any near-term Iran diplomatic dividend. That calculus holds as long as the war continues and US attention remains fixed on the Middle East."],
  ...
  {
    id:6,cat:"economics",code:"ECON-01",heat:5,status:"escalating",updated:"Apr 17 2026",
    title:"Oil Shock and Global Economy",
    sub:"Strait of Hormuz and Energy Markets",
    card:"Day 48. Mid-April supply cliff has arrived — SPR releases exhausted, Iranian exemptions expired. Market now absorbing full disruption without buffer. Kharg Island damage adds independent production suppression on top of Strait paralysis. $150+ barrel scenarios now in active range.",
    ...
    summary:"Day 48 of Strait disruption. The mid-April supply cliff warned about by analysts has arrived: SPR releases are exhausted and Iranian export exemptions have expired, leaving the market to absorb the full disruption without the buffer that cushioned the first six weeks. Kharg Island damage — struck April 7 — adds independent suppression of Iranian oil exports on top of Strait paralysis. Fuel rationing has deepened globally. The $150-200/barrel range modeled as a supply cliff scenario is now in active trading range. Global recession risk has materially increased with each week the Strait remains commercially paralyzed.",
    ...
    insights:["The mid-April supply cliff has now arrived. This is no longer a warning — it is the current condition. The SPR buffer is gone. The market is absorbing the full disruption. The second-order damage will be visible in inflation figures within weeks.","Kharg Island being struck changes the equation permanently — it handles 90% of Iranian oil exports. Even if the Strait reopens tomorrow, Kharg damage suppresses Iranian production for months. The oil disruption has partially decoupled from the military situation.","The $14T in global stock losses is already larger than the GDP of every country except the US and China. A ceasefire doesn't unwind that — it just stops the bleeding. The losses are real and already embedded in pension funds, sovereign wealth funds, and consumer balance sheets.","Dual Strait plus Red Sea disruption is historically unprecedented. These are the two most important shipping chokepoints on earth. Having both constrained simultaneously is not something the global economy was modeled to handle.","The $580M insider trading probe suggests someone knew. That is a secondary story with primary-story implications.","At six weeks of disruption, the shock has crossed from acute crisis to structural repricing. Insurance underwriters, shipping companies, and energy markets are recalibrating long-term assumptions — not just reacting to short-term events. This means the economic consequences persist even after a ceasefire because contracts, premiums, and infrastructure decisions have already been made on a higher-risk basis.","The countries without oil — Japan, South Korea, most of Europe — are experiencing a transfer of wealth to oil-producing nations on a scale not seen since the 1970s. This is a redistribution, not a destruction. The question is what the recipients do with the windfall and whether the losers make structural changes."],
  ...
  {
    id:7,cat:"geopolitics",code:"CANADA-01",heat:4,status:"developing",updated:"Apr 17 2026",
...
const AI_STORIES = [
  ...
  {
    id:"F03",code:"AI-SEC-01",heat:5,status:"escalating",updated:"Apr 17 2026",
    title:"AI Security & Supply Chain",
    sub:"Attacks, Leaks, and the New Threat Landscape",
    card:"IRGC Stargate UAE annihilation threat has not been executed in 14 days since April 3. Either condition (US striking power plants) was not met, or the threat was deterrent posture. Gulf AI infrastructure risk remains elevated as war continues at Day 48. Claude Code supply chain attacks ongoing.",
    summary:"The IRGC threatened complete annihilation of OpenAI's $30B Stargate UAE on April 3, conditional on US striking Iranian power plants. As of Day 48 (April 17), the threat has not been executed. Iranian power plants have not been publicly confirmed as struck — either US targeting restraint held or the threat was deterrent posture rather than operational intent. Gulf AI infrastructure risk remains elevated for as long as the war continues. Earlier: Iranian drones struck AWS ME-CENTRAL-1 (March 1) and Oracle Dubai (April 2). The Claude Code supply chain attack (March 31) and trojanized repo campaign remain active threat vectors.",
    ...
    insights:["A single misconfigured .npmignore exposed 512,000 lines of IP. This is not a sophisticated attack — it is a fundamental release engineering failure at a company preparing to go public.","The Stargate UAE threat with satellite imagery is a different category. Releasing imagery of a facility that was not publicly located signals intelligence penetration of Gulf infrastructure that goes beyond what was assumed.","The concurrent axios attack was not related to the source leak but the overlap created maximum confusion — a pattern that benefits attackers.","For a student using Claude Code: the risk surface is now permanent. Any unofficial source, any GitHub repo claiming to be leaked Claude Code — all are live threat vectors.","The IRGC not executing the Stargate threat in 14 days is significant either way. If the condition (power plant strikes) was not met: US targeting restraint is holding specifically to avoid triggering Gulf tech retaliation, meaning US military planners are making active tradeoffs to protect AI infrastructure. If the threat was deterrent: IRGC signaling capability without operational intent, which makes future threats harder to distinguish from bluffs.","The Gulf AI infrastructure attack surface is larger than the specific strikes suggest. Two AWS availability zones and Oracle Dubai are the confirmed cases. The full scope of what IRGC's released satellite imagery covers — facilities that were not publicly located — implies a broader targeting intelligence picture that hasn't been published."],
...
const WAR_STORIES = [
  {
    id:"W01", code:"IRAN-W01", heat:5, status:"active-war", updated:"Apr 17 2026",
    title:"Iran — Operation Epic Fury",
    sub:"US-Israel War on Iran · Day 48",
    card:"Day 48. Fourth deadline extension confirmed — war continues. Kharg Island damage now independently suppressing oil exports. IRGC Stargate UAE threat not executed in 10 days. Oman channel active. Human cost mounting with each day of no settlement.",
    toll:{
    ...
    front:{
      summary:"Day 48. US and Israeli strikes continuing against nuclear infrastructure, missile facilities, and military targets. Kharg Island, struck April 7, now independently suppressing Iranian oil exports — the oil disruption has become partially self-sustaining even absent Strait paralysis. Iranian proxy operations remain active across Lebanon, Iraq, and Yemen. Strait of Hormuz commercially paralyzed — not formally closed but functionally shut. Fourth diplomatic deadline extension confirmed. IRGC Stargate UAE annihilation threat has not been executed.",
      active_fronts:[
      ...
      recent_movements:[
        "Apr 17: Day 48. Fourth deadline extension confirmed — war continuing with no ceasefire in place",
        "Apr 17: IRGC Stargate UAE annihilation threat has not been executed in 10 days since April 7 deadline",
        "Apr 17: Kharg Island damage now independently suppressing Iranian oil exports",
      ...
      assessment:"Day 48 without ceasefire. The fourth deadline extension confirms the pattern: neither side has sufficient internal consensus to make the concessions required for a deal. The Kharg Island damage has created an independent economic disruption track — even a ceasefire that reopens the Strait does not immediately restore Iranian oil exports or lower global prices to pre-war levels. The IRGC not executing the Stargate UAE threat in 10 days reduces near-term AI infrastructure risk slightly, but the broader military situation remains fundamentally unchanged. The diplomatic track through Oman remains the only active channel."
    },
    ...
    insights:["The Oman FM announcement the day before — Iran had agreed to nuclear limits — is the detail that will define historical judgment of this operation. Strikes happened anyway.","Kharg Island before the deadline is either the military running independent of diplomacy, or deliberate pressure. Either reading is alarming.","220 children dead. At day 48, the weight on the diplomatic track is immense and accumulating.","Mojtaba's installation enabled by the strikes — the IRGC chose hardening over opening. That is a consequence of the operation, not despite it.","Four deadline extensions without a deal reveals the structural problem: the Trump administration has no domestic political framework for what accepting Iran's demands looks like, and Iran's IRGC-installed leadership has no domestic political framework for what concessions look like. Both sides are extending because the next step — escalation or capitulation — is worse than delay.","Kharg Island damage has created what might be called strategic irreversibility: even a full ceasefire and Strait reopening does not restore the pre-war oil supply picture for months. The economic damage has partly decoupled from the military situation. This reduces Iran's leverage (Strait paralysis was its primary economic weapon) while also reducing the US's urgency to reach a deal quickly."],
    questions:["Is Iran's 10-point counter being negotiated seriously or are both sides still posturing?","Will IRGC carry out the Stargate UAE threat — and why hasn't it happened in 10+ days?","What is the minimum ceasefire both sides could accept and sell domestically?","Does the Kharg Island damage change Iran's negotiating leverage — it reduces the Strait-closure threat while also giving Iran an independent grievance?"],
  ...
  {
    id:"W02", code:"PAL-01", heat:5, status:"active-war", updated:"Apr 17 2026",
    title:"Palestine — Gaza War",
    sub:"Israel-Hamas · Ongoing since October 7, 2023",
    card:"Gaza war continues with no ceasefire. Famine in northern Gaza deepening. Cairo negotiations remain collapsed. Iran war has fully absorbed regional diplomatic bandwidth — no serious Gaza ceasefire effort while Strait is paralyzed. Over 52,000 Palestinians dead, figure continues to mount.",
    toll:{
  ...
  },
  {
    ...
    card:"Russia has used 10 additional days of US distraction to advance in Donetsk. European NATO support accelerating to compensate. Istanbul ceasefire talks structurally stalled — neither side has moved from stated positions. THAAD still redirected to Iran theater.",
    toll:{
  ...
  {
    id:"W04", code:"SDN-01", heat:4, status:"active-war", updated:"Apr 17 2026",
    title:"Sudan — Civil War",
    sub:"SAF vs. RSF · The World's Forgotten War",
    card:"Sudan civil war continues with near-zero international coverage as Iran dominates all attention. RSF advancing in Gezira. El Fasher still under siege. Famine worsening. 150,000+ dead. The forecasted trajectory — worse by the time anyone looks — is materializing.",
    toll:{
    ...
    insights:["Sudan is what happens when a humanitarian crisis has no geopolitical sponsor. Iran has oil and nukes. Ukraine has NATO allies. Sudan has nothing that the major powers need urgently — so 150,000 people have died in relative silence.","The RSF is backed by UAE and Wagner. The SAF is backed by Egypt. The proxy war dimension explains why the Jeddah talks failed — neither external patron wants the other to win.","The Gezira advance is more consequential than the military maps suggest. Gezira was Sudan's breadbasket. Its destruction is famine-as-weapon — a slow mechanism more deadly than direct killing.","This story will matter more when the Iran crisis ends and international attention returns. The trajectory is clearly worse. Whoever is paying attention at that point will find a country that has been destroyed.","The Iran war has provided cover for 48 days of RSF advance in Sudan. Every international mechanism that might generate pressure — UN Security Council, African Union, Arab League — is occupied with the Middle East. The opportunity cost of the Iran war for Sudan is measured in the additional territory RSF has taken and the additional famine spread while nobody was watching.","The forecast from April 5 has been confirmed: this story is worse, and nobody is watching. The El Fasher siege is the specific indicator — if it falls while international attention is elsewhere, a genocide designation becomes likely and the window for prevention will have passed."],
  ...
  {
    id:"W07", code:"LBN-01", heat:4, status:"active-war", updated:"Apr 17 2026",
    title:"Lebanon — Hezbollah Front",
    sub:"Hezbollah vs. Israel · Direct front activated by Iran war",
    card:"Day 48 — Hezbollah front continues. Precision munitions and rocket barrages ongoing. Northern Israel evacuation now 48 days extended from Oct 2023 baseline. Ceasefire entirely dependent on Iran outcome. Hezbollah burning stockpile with no resupply path if Iran makes peace.",
    toll:{
...
const CANADA_STORIES = [
  {
    id:"C01", code:"CARNEY-01", heat:4, status:"developing", updated:"Apr 17 2026",
    title:"The Carney Government",
    sub:"Mandate, Strategy & the Weight of Four Crises",
    card:"Carney government 9 days past the April 8 update. Oil shock deepening with supply cliff materializing. CUSMA negotiations ongoing under tariff pressure. China deal fate still unresolved. Carney's central banking instinct — systems thinking over messaging — is being tested by the speed of events.",
    ...
    insights:["Carney is governing in a structural trap: his entire strategic logic depends on the US not noticing or not caring about the China engagement. Trump has already noticed. The 100% tariff threat is the tell.","The anti-Trump positioning that won the election creates a governing constraint — he cannot be seen to capitulate to Washington without political cost at home. That limits his negotiating flexibility in ways a less rhetorically committed PM would not face.","Carney's central banking background is an asset for crisis management and a liability for political communication. He speaks in probabilities and hedge-qualified statements. Canadian voters want certainty. That gap will matter.","The China bet is the right strategic logic — Canada genuinely needs to diversify — but the execution timeline is wrong. Diversification takes years to produce results. The US tariff threat operates on weeks. He needs the long game to win before the short game destroys him.","Alberta is the wildcard. High oil prices are creating a provincial revenue windfall that makes Premier Smith more assertive, not more cooperative. The federation tension is structural and will outlast any single crisis.","The mid-April supply cliff materializing changes Carney's fiscal picture: oil revenues are higher than modeled at $110-126/barrel, but inflation is accelerating faster than the revenue can offset. The Bank of Canada rate-cutting cycle is now fighting both recession risk and inflation simultaneously — the stagflation scenario that central bankers most fear.","Carney is the only G7 leader with a central banking background navigating this crisis. That is both an advantage (credibility with markets, genuine understanding of monetary mechanisms) and a constraint (technocratic communication style in a moment that demands political theater). His handling of this period will define his legacy more than the election that brought him to power."],
  ...
  {
    id:"C02", code:"CUSMA-01", heat:4, status:"developing", updated:"Apr 17 2026",
  ...
  {
    id:"C03", code:"ECON-CA-01", heat:4, status:"developing", updated:"Apr 17 2026",
