...
const OVERVIEW = {  summary: "Day 51. Strait of Hormuz partially reopened — oil at $87/barrel, down from $126 peak — but Kharg Island's 80% destruction means Iranian export capacity is structurally impaired regardless of diplomatic outcome. Russia launched its largest aerial attack of the conflict on April 16 (~700 drones and missiles), timed to exploit Ukraine's degraded air defenses while US attention was on Iran diplomacy. Carney's Liberals secured a parliamentary majority on April 13 (174/343 seats via three byelections) and suspended the federal fuel excise tax effective April 20. DOJ has 11 days to file its 9th Circuit brief against Anthropic — April 30 deadline now the defining legal moment.",  leaderboard: [    {code:"IRAN-01", title:"Operation Epic Fury", change:"Day 51. Strait partially reopened — oil at $87, down from $126 peak. Kharg Island 80% destroyed — Iranian export capacity structurally impaired regardless of ceasefire. Diplomatic impasse continues.", heat:5, status:"active-war"},    {code:"UKR-01", title:"Ukraine — Russia War", change:"Russia launched ~700 drones and missiles April 16 — largest aerial attack since war began. Germany and Netherlands committed new Patriot funding. European support becoming primary as US focused on Iran.", heat:4, status:"active-war", updated:"Apr 19 2026"},    ...(other leaderboard entries unchanged)...  ],  cross_story_alerts: [    {      codes:["IRAN-01","ECON-01","AI-SEC-01","UKR-01"],      date:"Apr 19 2026",      title:"Four-Way System Collapse",      alert:"The partial Strait reopening (IRAN-01) reduces acute pressure but does not resolve structural damage — Kharg Island destruction means Iranian export capacity is impaired for months regardless of diplomacy. Russia's April 16 aerial assault (UKR-01) confirms it is exploiting the US two-front problem. AI infrastructure remains a wartime target (AI-SEC-01). Oil at $87 eases but does not end the ECON-01 shock.",      severity:"critical"    },    {      codes:["CARNEY-01","CUSMA-01","GEO-01"],      date:"Apr 19 2026",      title:"Canadian Strategic Trap Tightening",      alert:"Carney's new majority gives him domestic runway but does not resolve the structural trap: the 100% tariff threat on the China deal, CUSMA renegotiation from weakness, and Trump's demonstrated willingness to use economic coercion are all accelerating simultaneously. The China engagement that won Carney the election is now the lever Washington is pulling hardest.",      severity:"high"    },    ...(other alerts unchanged)...  ]};

const EVENTS = [
  {date:"Apr 19 2026", code:"IRAN-01", type:"SYNTHESIS", content:"Day 51 synthesis pass. Strait partially reopened — oil at $87/barrel, down from $126 peak. Kharg Island 80% destroyed — Iranian export capacity structurally impaired. 25 stories reviewed from Apr 18 pipeline run."},
  {date:"Apr 16 2026", code:"UKR-01", type:"NEW_FACT", content:"Russia launched approximately 700 drones and missiles in largest aerial attack since war began — targeted civilian infrastructure across multiple cities. Germany and Netherlands committed new Patriot missile funding."},
  {date:"Apr 13 2026", code:"CARNEY-01", type:"NEW_FACT", content:"Liberals won three byelections securing parliamentary majority — seat count 174/343. Four Conservative defectors and one NDP defector contributed. Carney now governing without opposition support for first time."},
  {date:"Apr 13 2026", code:"CARNEY-01", type:"STATUS_UPDATE", content:"Fuel excise tax suspended April 20–September 7 — cost $2.4B. First major cost-of-living intervention of majority era."},
...
const WAR_STORIES = [
  ...
  {
    id:"W02", code:"PAL-01", heat:5, status:"active-war", updated:"Apr 19 2026",
    title:"Palestine — Gaza War",
    sub:"Israel-Hamas · Ongoing since October 7, 2023",
    card:"Month 18. Cairo negotiations collapsed. 52,000+ Palestinians dead. IDF killed 11 civilians including 2 children on April 16. UN Women: 47 women and girls killed daily throughout conflict. Famine in northern Gaza. Kharg Island destruction means Gaza's patron is now fighting for survival.",
    toll:{
  ...
  {
    id:"W03", code:"UKR-01", heat:4, status:"active-war", updated:"Apr 19 2026",
    title:"Ukraine — Russia War",
    sub:"Ongoing since February 2022 · Year 3",
    card:"Russia launched largest aerial attack of the conflict on April 16 (~700 drones and missiles), exploiting US focus on Iran diplomacy. Germany and Netherlands committed new Patriot funding. European support becoming primary as US remains focused on Iran. Russia extracting Zaporizhzhia manganese — economic integration of seized territory.",
    toll:{
    ...
    front:{
      ...
      recent_movements:[
        "Apr 16 2026: Russia launched approximately 700 drones and missiles — largest aerial attack since war began, targeted civilian infrastructure across multiple cities",
        "Apr 2026: Germany and Netherlands committed hundreds of millions in new funding for Patriot missiles and drone production",
        "Apr 2026: Russia began developing manganese deposits in occupied Zaporizhzhia Oblast — economic integration of seized territory",
        "Apr 2026: Austria joined international tribunal to prosecute Russian aggression",
    ...
    confirmed:["War began February 24 2022 — Russian full-scale invasion of Ukraine","Russia holds approximately 20% of Ukrainian territory as of April 2026","US THAAD interceptors partially redirected to Iran theater — Ukraine air defense degraded","European NATO members accelerating direct military support to compensate for US distraction","Ceasefire talks in Istanbul active but stalled on territorial preconditions","Russia making incremental advances in Donetsk timed to US distraction on Iran","Ukraine conducting long-range drone strikes on Russian oil infrastructure","Black Sea grain corridor intermittently disrupted","Zaporizhzhia nuclear plant under intermittent shelling — IAEA on-site monitoring","Russia launched approximately 700 drones and missiles on April 16 2026 — largest aerial assault since the war began — targeting civilian infrastructure across multiple cities","Germany and Netherlands committed hundreds of millions in new funding for Patriot missiles and drone production in April 2026","Russia began developing manganese deposits in occupied Zaporizhzhia Oblast — signaling economic integration of seized territory","Austria joined international tribunal to prosecute Russian aggression against Ukraine"],
    developing:["Whether US attention returns to Ukraine after Iran ceasefire — or whether the distraction creates permanent repositioning","Whether European NATO support can fully compensate for US resource shift","Whether Istanbul ceasefire talks produce anything substantive","Whether Russia's April 16 attack was a one-time signal or the opening of a larger offensive push","Whether Ukraine's long-range drone campaign on Russian oil infrastructure changes the economic calculus","Whether Russian economic integration of Zaporizhzhia mineral resources creates a permanent annexation incentive that hardens Moscow's negotiating floor","Whether Ukraine's pivot to domestic missile production can scale fast enough to replace degraded Western shipments"],
    insights:["Russia waited for its moment and found it. The Iran war is the US distraction Russia needed. The question is whether Moscow uses incremental advances to improve its negotiating position or attempts something larger.","The THAAD redirection to Iran is the most concrete military consequence of the two-front problem. Ukraine's air defense is measurably degraded. Russia knows this.","European NATO members stepping up is a structural shift — the Iran war is accelerating European strategic autonomy in a way that the Trump administration's NATO skepticism did not fully achieve on its own.","Three years in, both sides have fought to a position where neither can achieve a decisive victory but neither can accept the terms the other is offering. That is a frozen conflict structure — dangerous because it can unfreeze suddenly.","The April 16 attack timing is not coincidental. Russia chose the moment when international diplomatic attention was concentrated on Iran ceasefire negotiations and US resources were maximally committed elsewhere. This is deliberate strategic opportunism — Russia is reading the same calendar everyone else is.","Russia beginning manganese extraction in Zaporizhzhia is the most concrete signal yet that Moscow treats occupation as permanent. Military control can be temporary. Economic integration — infrastructure, extraction contracts, supply chains — is harder to reverse. This is annexation by development."],
    questions:["Does the Iran ceasefire (if achieved) allow US to redirect resources back to Ukraine — and how quickly?","Is Russia's April 16 attack the beginning of a larger offensive or a one-time signal?","Do Istanbul ceasefire talks have any realistic path to agreement?","Does European strategic autonomy on Ukraine survive as a durable shift or revert after the Iran crisis?","Does Russian economic integration of Zaporizhzhia produce a settlement baseline that makes the territory permanently harder to recover?"],
...
const CANADA_STORIES = [
  {
    id:"C01", code:"CARNEY-01", heat:4, status:"developing", updated:"Apr 19 2026",
    title:"The Carney Government",
    sub:"Mandate, Strategy & the Weight of Four Crises",
    card:"Liberals secured majority April 13 (174/343 via three byelections and four Conservative defectors). Fuel excise tax suspended April 20. Majority changes the governing calculus — but 100% tariff threat on China deal and CUSMA pressure are accelerating simultaneously.",
    summary:"Mark Carney became PM January 2026, won a majority in the March federal election on anti-Trump positioning, and consolidated that majority to 174/343 seats via three byelection wins on April 13. He suspended the federal fuel excise tax April 20–September 7 ($2.4B cost) as the first major cost-of-living intervention of the majority era. The structural trap has not changed: the China engagement that won him the election is now the lever Washington is pulling hardest against him. The majority gives him domestic runway but not strategic freedom.",
...
const CLIMATE_STORIES = [
  {
    id:"CL01", code:"EMISSIONS-01", heat:4, status:"developing", updated:"Apr 19 2026",
    ...
    insights:["The 1.5°C target is functionally dead. This is not a political statement — it is arithmetic. Accepting this is not defeatism; it is the precondition for honest policy design for the actual scenario we face.","The gap between commitment and trajectory is the central governance failure of climate policy. Countries make pledges at COPs that their domestic political systems cannot deliver. No country has solved this structural mismatch.","China's simultaneous massive renewable build-out and continued coal expansion is the most important climate story in the world right now. Which trend wins determines global emissions trajectory more than any other single factor.","The methane underreporting story is significant. Satellite monitoring reveals emissions substantially higher than official reporting. Methane is approximately 80 times more potent than CO2 over 20 years. The real-world warming effect is materially worse than official figures suggest.","The Iran war oil shock is the strongest argument for the green transition ever made — and it is being made in real time. Countries that diversified away from fossil fuels are less exposed. Countries that didn't are paying for it.","The expansion to 41 ETS systems covering 26% of global GHG emissions and generating $80B in annual revenue represents a governance infrastructure signal — not because carbon pricing alone solves the trajectory problem, but because the fiscal machinery for climate action is expanding even as the commitment-trajectory gap widens. Revenue scale matters when it starts funding actual transition.","Urban methane rising 6% since 2019 per satellite monitoring, combined with the documented 70% underreporting gap in fossil fuel methane, means city-level climate pledges are structurally unreliable. C40 cities making net-zero commitments are measuring against a baseline that understates actual emissions by roughly a third."],
    questions:["At what temperature does the current trajectory actually land — and what does 2.5°C or 3°C mean concretely?","Does China's renewable build-out outpace its coal expansion on a net emissions basis?","Does the US IRA implementation survive the current administration?","Is there any scenario in which emissions reductions reach the pace required to avoid the worst outcomes?","Can satellite-based methane monitoring force cities to restate their actual emissions baselines — and what happens to climate commitments when they do?"],
  ...
  {
    id:"CL05", code:"FOSSIL-01", heat:4, status:"developing", updated:"Apr 19 2026",
    ...
    confirmed:["Countries with high renewable energy penetration experiencing smaller economic shock from oil price spike","Countries with low renewable penetration implementing emergency demand rationing","Japan accelerating nuclear restarts and renewable procurement in direct response to Strait closure","South Korea fast-tracking LNG terminal diversification and offshore wind expansion","Germany citing Iran war as justification for accelerated Energiewende implementation","US Gulf Coast oil production increasing to fill Strait supply gap — short-term fossil reinforcement","Saudi Arabia and UAE increasing production","IEA strategic petroleum reserve releases insufficient to fully cover Strait disruption","EU emergency energy measures activated — coordinated demand reduction and supply diversification","Bangladesh paid $880M for emergency LNG spot purchases at double pre-war prices following Iran Strait closure","Pakistan's pre-crisis solar buildout resulted in significantly lower exposure to the oil price shock compared to Bangladesh"],
    developing:["Whether Japan's nuclear restart and renewable acceleration survives domestic political opposition","Whether South Korea's clean energy acceleration produces lasting policy or reverts post-crisis","Whether US clean energy rollback is reversed in response to energy security arguments","Whether global LNG infrastructure investment locks in gas dependency for 30+ years","Whether the energy security frame permanently replaces the climate frame as the political argument for transition","Whether Bangladesh shifts toward renewables after costly emergency LNG — $880M spot cost is now a documented case study in transition delay cost","Whether Pakistan's solar success becomes a replicable model for other import-dependent emerging economies"],
    insights:["The energy security argument for the transition is more politically durable than the climate argument in most democratic systems. Climate is abstract and future-oriented. Energy security is immediate and self-interested. The Iran war is making it viscerally real.","The structural irony: the countries increasing production to fill the Strait gap are primarily the Gulf producers whose revenue depends on sustained fossil fuel demand. They benefit from both the crisis — higher prices — and the eventual resolution — continued demand.","Japan and South Korea's responses are the most significant to watch. Both are large wealthy democracies with high fossil fuel import dependency, developed technological capacity, and strong energy security instincts.","The LNG infrastructure lock-in risk is real. Building a new LNG terminal commits to 30+ years of gas imports. Countries fast-tracking LNG diversification may be trading one fossil fuel dependency for another.","The Bangladesh/Pakistan divergence is the cleanest natural experiment in energy policy in recent history. Bangladesh paid $880M for emergency LNG spot purchases at double pre-war prices. Pakistan, which built solar aggressively before the crisis, experienced the same oil shock with a fundamentally different exposure profile. The pre-crisis investment decision — not the crisis itself — determines the crisis response. This is the empirical case for transition made by the oil shock directly."],
    questions:["Does the energy security argument produce lasting clean energy policy change in major fossil fuel importers?","Does LNG infrastructure investment lock in gas dependency conflicting with net zero timelines?","Do Japan and South Korea make permanent policy shifts or revert when the crisis passes?","Does any OPEC+ member use the crisis revenue to begin domestic economic diversification?","Does Bangladesh's $880M LNG experience shift its policy toward renewables — and does it replicate Pakistan's solar model?"],
