...
const OVERVIEW = {
  summary: "A two-week ceasefire between the US, Israel, and Iran took effect April 7-8, mediated by Pakistan, Türkiye, and Egypt — but Lebanon was excluded and Israel continued strikes on Beirut the same day. Six days later, on April 13, the US announced a naval blockade of the Strait of Hormuz after US-Iran negotiations in Islamabad collapsed without agreement on Iran's nuclear program. The ceasefire and blockade are now simultaneously in effect — structurally incompatible frameworks operating on the same geography. Oil spiked to $102-105/barrel on blockade news; tanker traffic through the Strait dropped from 100+ ships/day to fewer than three. Iran is reorganizing its ballistic missile forces during the ceasefire window. The dominant question is whether Pakistan can broker a 45-day extension before the two-week ceasefire expires.",
  leaderboard: [
    {code:"IRAN-01", title:"Operation Epic Fury", change:"Two-week ceasefire took effect April 7-8, mediated by Pakistan, Türkiye, Egypt. Lebanon excluded — Israel continued Beirut strikes. US-Iran talks in Islamabad collapsed on nuclear terms. US naval blockade announced April 13 — ceasefire and blockade now simultaneously in effect. Iran reorganizing missile forces during ceasefire window.", heat:5, status:"Active Ceasefire"},
    {code:"ECON-01", title:"Oil Shock & Global Economy", change:"US naval blockade of Strait announced April 13 after Islamabad talks collapsed. Oil surged to $102-105/barrel on blockade news — tanker traffic fell to under three/day. Brent now around $94/barrel. Blockade and ceasefire simultaneously in effect — structurally incompatible. Global recession risk rising.", heat:5, status:"escalated"},
    ...
    {code:"AI-GOV-01", title:"Autonomous Weapons Race", change:"Anthropic injunction reframes the story — courts may become the governance mechanism. DoD Directive 3000.09 permits autonomous weapons with undefined human judgment standard. Kalinowski resigned from OpenAI over surveillance and lethal autonomy. 11,000 US munitions in 30 days — governance gap now empirically measured.", heat:4, status:"escalating"},
    {code:"AI-SEC-01", title:"AI Infrastructure Under Fire", change:"Anthropic restricted Claude Mythos access citing offensive weaponization risk. CISA joint advisory April 7 on Iranian OT exploitation of US critical infrastructure. Crypto exchanges seeking Mythos access for zero-day defense. Iranian cyberattacks on critical infrastructure ongoing.", heat:5, status:"escalating"},
  ...
  cross_story_alerts: [
    ...
    {
      codes:["IRAN-01","ECON-01"],
      date:"Apr 13 2026",
      title:"Ceasefire and Blockade Simultaneously Active",
      alert:"The two-week ceasefire (April 7-8) and the US naval blockade of the Strait of Hormuz (April 13) are now simultaneously in effect. The ceasefire is a military pause; the blockade is active economic coercion. These frameworks are structurally incompatible — one or both will have to yield. Iran's ballistic missile forces are being repositioned during the ceasefire window. Pakistan is negotiating a 45-day extension. Every shipping nation with Gulf oil exposure is watching whether the US will enforce the blockade against third-party flagged tankers.",
      severity:"critical"
    },
  ]
};
...
const EVENTS = [
  {date:"Apr 16 2026", code:"IRAN-01", type:"STATUS_UPDATE", content:"ARC pipeline update: ceasefire (Apr 7-8) and naval blockade (Apr 13) now simultaneously active. IRAN-01, ECON-01, AI-SEC-01, AI-GOV-01 updated. 17 stories not processed due to Gemini API quota exhaustion."},
  {date:"Apr 13 2026", code:"ECON-01", type:"NEW_FACT", content:"US announced naval blockade of Strait of Hormuz following collapse of US-Iran negotiations in Islamabad on nuclear terms. Oil surged 8% on announcement. Tanker traffic dropped to under three/day. Brent now ~$94/barrel."},
  {date:"Apr 8 2026", code:"IRAN-01", type:"STATUS_CHANGE", content:"Two-week ceasefire took effect April 7-8 — mediated by Pakistan, Türkiye, Egypt. Lebanon excluded from ceasefire terms. Israel continued strikes on Beirut. Iran reorganizing ballistic missile forces during ceasefire window."},
  {date:"Apr 7 2026", code:"ANTHRO-01", type:"NEW_FACT", content:"Anthropic restricted public access to Claude Mythos — its vulnerability-discovery AI model — citing offensive weaponization concerns. CISA issued joint advisory on Iranian cyber exploitation of OT devices."},
...
const STORIES = [
  ...
  {
    id:2,cat:"ai",code:"AI-GOV-01",heat:4,status:"developing",updated:"Apr 16 2026",
    title:"Autonomous Weapons Race",
    sub:"Global AI in Warfare — No Governance Framework",
    card:"A global AI arms race is accelerating, with the US and China competing for dominance in AI-backed weapons systems and raising concerns about governance and ethical implications.",
    ...
    summary:"No binding international framework on AI in warfare. UN debated LAWS without result. Iran war made governance gap concrete: 11000+ munitions in 30 days, 25% THAAD interceptors burned. Anthropic injunction may make courts the de facto governance mechanism. DoD Directive 3000.09 permits autonomous weapons with human oversight. The US designated Anthropic a national security risk after it restricted military access to its AI models, while OpenAI reached a deal with the Pentagon. A global AI arms race is escalating, particularly between the US and China.",
  ...
  {
    id:3,cat:"geopolitics",code:"IRAN-01",heat:5,status:"active-war",updated:"Apr 16 2026",
    title:"Operation Epic Fury",
    sub:"US-Israel Strikes on Iran — Day 38",
    card:"A two-week ceasefire between the US, Israel, and Iran began April 7-8, 2026, but its future is uncertain and fighting continues in Lebanon.",
  ...
  {
    id:6,cat:"economics",code:"ECON-01",heat:5,status:"escalating",updated:"Apr 16 2026",
    title:"Oil Shock and Global Economy",
    sub:"Strait of Hormuz and Energy Markets",
    card:"A US naval blockade of the Strait of Hormuz is in effect following collapsed negotiations with Iran, causing significant oil market volatility.",
    ...
    summary:"Day 35 of Strait closure — largest oil supply disruption since 1970s. Brent peaked at 126/barrel, currently around 94/barrel. Mid-April supply cliff approaching as SPR releases run out. Fuel rationing spreading globally. Jet fuel up 95% in US since war began. US naval blockade of the Strait of Hormuz implemented April 13, 2026, following failed negotiations. Oil prices initially surged, then eased slightly. Global economic slowdown projected.",
    confirmed:["Brent crude peaked $126/barrel — largest disruption since the 1970s oil embargo","Currently trading $110-113/barrel as 8pm deadline creates cautious optimism","Saudi Aramco rerouting crude via East-West pipeline to Red Sea — approximately 1.9 million bpd against theoretical capacity of 5 million bpd — far from enough","OPEC+ announced 206,000 bpd output increase from April — covers less than 0.2 percent of global demand","Houthis resumed Red Sea attacks simultaneously — dual disruption compounding","Kharg Island struck April 7 — handles 90% of Iran's oil exports","Jet fuel up 95% in US since war began","Philippines implementing 4-day work weeks to reduce fuel consumption","Vietnam implementing fuel rationing","Australia reporting fuel shortfalls","New Zealand canceling flights","European airports implementing jet fuel restrictions","QatarEnergy declared force majeure on LNG shipments","$14T wiped from global stocks since war began","$580M insider trading investigation opened into suspicious pre-war options activity","$150-200/barrel scenarios actively modeled for mid-April supply cliff","US announced naval blockade of Strait of Hormuz April 13 2026 following collapse of US-Iran negotiations in Islamabad","Brent crude surged 8% to $102.80/barrel and WTI surged 8.61% to $104.88/barrel on blockade announcement","Tanker traffic through Strait dropped from 100+ ships/day to fewer than three after blockade","Blockade enforced with 10,000+ US personnel and dozens of warships — declared alongside existing ceasefire"],
    developing:["Whether ceasefire and blockade can coexist or one supersedes the other","Mid-April supply cliff — SPR releases and exemptions running out, potential doubling of daily supply loss","Whether Saudi Arabia and UAE pipeline alternatives can absorb significant volume","How China, India, and EU respond to US naval blockade of an international shipping lane","Whether sustained oil shock tips into global recession — global debt-to-GDP ratios rising sharply","Effect on developing economies with no oil production buffer","Whether QatarEnergy force majeure triggers cascade of similar declarations","Whether Iran counters blockade with mine warfare or proxy attacks on US naval assets"],
    insights:["The mid-April supply cliff is the most important economic development not getting mainstream coverage. SPR releases are a one-time buffer. When they run out, the market faces the full disruption without a cushion.","Kharg Island being struck changes the equation — it handles 90% of Iranian oil exports. Even if the Strait reopens tomorrow, Kharg damage could suppress Iranian production for months.","The $14T in global stock losses is already larger than the GDP of every country except the US and China. A ceasefire tonight doesn't unwind that — it just stops the bleeding.","Dual Strait plus Red Sea disruption is historically unprecedented. These are the two most important shipping chokepoints on earth. Having both constrained simultaneously is not something the global economy was modeled to handle.","The $580M insider trading probe suggests someone knew. That is a secondary story with primary-story implications.","The naval blockade is legally and diplomatically different from the Strait paralysis. Paralysis was ships choosing not to transit. A blockade is the US declaring it will physically stop ships. China, India, and the EU are all shipping oil through international waters that the US has now claimed authority over — that claim will be contested in every relevant body of international law simultaneously."],
...
const AI_STORIES = [
  ...
  {
    id:"F03",code:"AI-SEC-01",heat:5,status:"escalating",updated:"Apr 16 2026",
    title:"AI Security & Supply Chain",
    sub:"Attacks, Leaks, and the New Threat Landscape",
    card:"Iranian cyberattacks are escalating, targeting critical infrastructure and prompting defensive measures like Anthropic's Claude Mythos access restrictions.",
    summary:"Iran war turned AI infrastructure into live military target. Iranian drones struck AWS ME-CENTRAL-1 UAE — two AZs offline 24hrs. IRGC threatened complete annihilation of Stargate UAE 30B datacenter. Claude Code source code leaked March 31 — 512000 lines. Malicious axios npm packages with RAT active. Supply chain attacks ongoing. Anthropic restricted Claude Mythos access due to vulnerability discovery capabilities. CISA warned of Iranian OT device exploitation. Crypto exchanges seek Claude Mythos access for zero-day defense.",
    confirmed:["Iranian Shahed drones struck AWS ME-CENTRAL-1 data centers in UAE — two of three availability zones offline for 24+ hours — first confirmed state attack on commercial cloud infrastructure","AWS Bahrain facility also struck — banking, ride-hailing, payments disrupted across Gulf","Iran IRGC released satellite imagery of Stargate UAE ($30B OpenAI/Nvidia/Oracle/SoftBank facility in Abu Dhabi) threatening complete and utter annihilation","Oracle Dubai facility struck April 2 — Oracle confirmed outage","Iran has threatened Nvidia, Microsoft, Apple, Google, and 14 other US tech companies with Gulf presence by name","Claude Code source code leaked March 31 — 512,000 lines via exposed .npmignore, 41,500+ GitHub forks","Malicious axios versions 1.14.1 and 0.30.4 published to npm — contain Remote Access Trojan","Malicious GitHub repo distributing Vidar Stealer and GhostSocks via ClaudeCode_x64.exe — appeared near top of Google results","Typosquatting campaign by user pacifier136 — empty stub packages matching internal Claude Code npm names","Anthropic accidentally sent DMCA notices to forks of their own official tutorial repo","Anthropic restricted public access to Claude Mythos — its vulnerability-discovery AI model — citing offensive weaponization concerns","CISA issued joint advisory April 7 2026 warning of Iranian state cyber exploitation of OT devices targeting US critical infrastructure","Major crypto exchanges including Coinbase and Binance seeking Claude Mythos access for zero-day defense capabilities"],
