...
const AI_STORIES = [{
  ...
  people: [{
    name: "Dario Amodei",
    role: "CEO, Anthropic",
    why: "Driving the Opus 4.6 and Capybara development agenda. Also the person who said publicly that Anthropic cannot rule out that Claude is conscious.",
    alignment: "Anthropic",
    status: "active"
  }, {
    name: "Boris Cherny",
    role: "Creator, Claude Code",
    why: "Built Claude Code from the ground up. The leaked source is his codebase.",
    alignment: "Anthropic",
    status: "active"
  }, {
    name: "Liang Wenfeng",
    role: "Founder, DeepSeek",
    why: "Demonstrated frontier AI capability from a fraction of the compute cost. Single most disruptive actor in the AI capability story for 2025-2026.",
    alignment: "Chinese tech (state-adjacent)",
    status: "active"
  }, {
    name: "Sam Altman",
    role: "CEO, OpenAI",
    why: "The competitive context for every Anthropic capability release. OpenAI signed the Pentagon deal Anthropic refused.",
    alignment: "OpenAI",
    status: "active"
  }]
}, {
...
const POWER_STORIES = [{
  ...
  implications: ["Defense contractors receive disproportionate share of federal tax dollars compared to domestic priorities", "Private sector profit motives drive up weapons costs compared to state-run defense industries", "War profiteering accountability initiatives gain momentum due to high visibility cases"],
  risks: ["Explosion of national debt from unchecked defense spending", "Erosion of manufacturing capacity from over-reliance on defense sector", "Strategic vulnerability when high-cost systems face low-cost adversarial equivalents"],
  toll: {},
  front: {},
